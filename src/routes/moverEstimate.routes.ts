...
/**
 * @swagger
 * /mover-estimates/request/{estimateRequestId}:
 *   get:
 *     summary: 견적 요청 상세 조회
 ...
 *             example:
 *               success: false
 *               message: "견적 요청 정보가 없습니다."
 */
router.get("/request/:estimateRequestId", moverEstimateController.getEstimateRequestById);
