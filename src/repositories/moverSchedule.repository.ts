  ...
  getMonthlySchedules: async (moverId: string, year: number, month: number): Promise<TMoverScheduleWithDetails[]> => {
    try {
      ...
      return estimates.map((estimate) => ({
        ...
        fromAddress: {
          id: estimate.estimateRequest.fromAddress.id,
          zoneCode: estimate.estimateRequest.fromAddress.zoneCode,
          city: estimate.estimateRequest.fromAddress.city,
          district: estimate.estimateRequest.fromAddress.district,
          detail: estimate.estimateRequest.fromAddress.detail ?? undefined,
          region: estimate.estimateRequest.fromAddress.region ?? "",
        },
        toAddress: {
          id: estimate.estimateRequest.toAddress.id,
          zoneCode: estimate.estimateRequest.toAddress.zoneCode,
          city: estimate.estimateRequest.toAddress.city,
          district: estimate.estimateRequest.toAddress.district,
          detail: estimate.estimateRequest.toAddress.detail ?? undefined,
          region: estimate.estimateRequest.toAddress.region ?? "",
        },
