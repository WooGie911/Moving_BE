...
describe('ReviewService', () => {
  ...
  describe('postReview', () => {
    it('성공적으로 리뷰를 작성한다', async () => {
      ...
      expect(mockRepository.getReviewDetailForAction).toHaveBeenCalledWith('review-1');
      ...
      const mockRequests = {
        items: [
          { 
            ...
            fromAddress: { id: 'addr-1', city: '서울', district: '강남구', detail: '101동 202호', region: 'SEOUL', zoneCode: '06123' },
            toAddress: { id: 'addr-2', city: '부산', district: '해운대구', detail: '301동 404호', region: 'BUSAN', zoneCode: '48001' },
            estimates: [{ 
              id: 'estimate-1', 
              moverId: 'mover-1', 
              status: 'ACCEPTED',
          ...
          { 
            ...
            fromAddress: { id: 'addr-3', city: '대구', district: '중구', detail: '201동 303호', region: 'DAEGU', zoneCode: '41911' },
            toAddress: { id: 'addr-4', city: '인천', district: '연수구', detail: '401동 505호', region: 'INCHEON', zoneCode: '22001' },
            estimates: [{ 
              id: 'estimate-2', 
              moverId: 'mover-2', 
              status: 'ACCEPTED',
